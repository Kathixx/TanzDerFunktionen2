...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_INSERTDB1_4 =
            "INSERT INTO Level"+
                    ...
                    "(4, '3cos(x+1)', 'Die allgemeine Form dieser Funktion lautet f(x)=a * sin(b*x+c)+d. Was geben die Parameter an ? a: Vergrößerung/Verkleinerung der Amplitude b: Streckung/Stauchung/Spiegelung an der x-Achse c: Verschiebung nach links oder rechts d: Verschiebung auf der y-Achse', 3, 1, 1, 0, -2.571, 0.571, 1.62);";
